 ...
 * @author Vitor
 */
public class Question4 extends javax.swing.JFrame implements ManipulaJogo {
     ...
     * @param pontuacao
     */
    public Question4(int questoesRespondidas, int pontuacao) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("A abstração de dados é a propriedade em virtude da qual apenas ");
        ...
        jLabel4.setText("os detalhes essenciais são exibidos ao usuário.");
    ...
    private void btVerificaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btVerificaActionPerformed
        ...
        Question5 proximaQuestao = new Question5(questoesRespondidas, pontuacao);
