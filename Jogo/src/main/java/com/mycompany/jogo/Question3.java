 ...
 * @author Vitor
 */
public class Question3 extends javax.swing.JFrame implements ManipulaJogo {
     ...
     * @param pont
     */
    public Question3(int questao, int pont) {
        initComponents();
        this.questoesRespondidas = questao;
        this.pontuacao = pont;
        buttons.add(btTrue1);
    ...
    private void initComponents() {
        ...
        jLabel3.setText(" Interface em Java,  pode ser considerada como um contrato ");
        ...
        jLabel4.setText("que quando assumido por uma classe não necessita ser implementado.");
    ...
    private void btVerificaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btVerificaActionPerformed
        ...
        Question4 proximaQuestao = new Question4(questoesRespondidas, pontuacao);
